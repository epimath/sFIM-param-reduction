...
# profindex = index within params for the parameter to be profiled
...
ProfParam = function(params,profindex,costfun,times,data,perrange=0.5,numpoints=10){
  ...
  for (i in 1:2){
    shortparams = params[-profindex] # remove profiled parameter
